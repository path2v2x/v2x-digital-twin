...
Developer-facing console for the twin-server `/drive` WebSocket API.
...
camera viewing belong to `apps/twin-web`; binary messages on `/drive` are
truth frames and are shown only in the flight recorder.
